...
export default function Home() {
    ...
    return (
        ...
        <MainLayout title={'Cars'} className={styles.main}>
            ...
            {!marks? <div>loader</div> : <select aria-label="Default select example" onChange={(e)=>{
                load(e.target.value)
            ...
            {!cars ? <div>loader</div> : <div className={styles.container}>


                {cars.list.map(c => <div className={styles.card} key={c._id}>
